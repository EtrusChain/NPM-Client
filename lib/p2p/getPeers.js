...
exports.getPeers = exports.User = void 0;
...
function dataBase() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, mongoose_1.connect)("".concat(process.env.MONGODB))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function getPeers() {
    return __awaiter(this, void 0, void 0, function () {
        var user, userArray, usersHostName, _i, user_1, iterator;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exports.User.find({})];
                case 1:
                    user = _a.sent();
                    userArray = [];
                    usersHostName = [];
